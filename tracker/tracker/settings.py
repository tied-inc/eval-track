...
class Settings(BaseSettings):
    ...
    s3_access_key: str = Field(default="", description="AWS access key ID for S3 authentication")
    s3_secret_key: str = Field(default="", description="AWS secret access key for S3 authentication")
